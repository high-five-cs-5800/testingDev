/*1538701074,,JIT Construction: v4385443,en_US*/
/**
...
try {
        ...
        for (var i = 0; i < sandboxWhitelist.length; i++) {
            ...
            with(this) {
                ...
                __d("JSSDKConfig", [], {
                    ...
                    "api": {
                        "mode": "warn",
                        "https_only": ["api", "getAccessToken", "getAuthResponse", "getLoginStatus", "getUserID", "login"],
                ...
                __d("OAuthControllerParameterName", [], (function(a, b, c, d, e, f) {
                ...
                __d("sdk.Cookie", ["QueryString", "sdk.Runtime"], (function(a, b, c, d, e, f, g, h) {
                    ...
                    function j(a, b, c, d) {
                        ...
                        d = d ? ";Secure" : "";
                        var e = i !== null && i !== ".";
                        e && (document.cookie = a + "=; expires=Wed, 04 Feb 2004 08:00:00 GMT" + d, document.cookie = a + "=; expires=Wed, 04 Feb 2004 08:00:00 GMT;domain=" + location.hostname + d);
                        var f = new Date(c).toUTCString();
                        document.cookie = a + "=" + b + (b && c === 0 ? "" : "; expires=" + f) + "; path=/" + (e ? "; domain=" + ((a = i) != null ? a : "") : "") + d
                    }
                    function k(a) {
                        a = a + h.getClientID();
                        a = new RegExp("\\b" + a + "=([^;]*)\\b");
                ...
                __d("URIBase", ["FBLogger", "URIRFC3986", "URISchemes", "ex", "invariant", "setHostSubdomain"], (function(a, b, c, d, e, f, g, h, i, j, k, l) {
                    __p && __p();
                    ...
                    function o(a, b, c, d) {
                        ...
                        if (e.userinfo !== null)
                            if (c) throw new Error(j("URI.parse: invalid URI (userinfo is not allowed in a URI): %s", a.toString()));
                            else return !1;
                        if (!a.getDomain() && ES(a.getPath(), "indexOf", !0, "\\") !== -1)
                            if (c) throw new Error(j("URI.parse: invalid URI (no domain but multiple back-slashes): %s", a.toString()));
                            else return !1;
                        if (!a.getProtocol() && n.test(b))
                            if (c) throw new Error(j("URI.parse: invalid URI (unsafe protocol-relative URLs): %s", a.toString()));
                            else return !1;
                        if (a.getDomain() && a.getPath() && !ES(a.getPath(), "startsWith", !0, "/"))
                            if (c) throw new Error(j("URI.parse: invalid URI (domain and path where path lacks leading slash): %s", a.toString()));
                            else return !1;
                        return !0
                    }
                    var p = [];
                    ...
                    function q(a, b) {
                        "use strict";
                        b || k(0, 2966), this.$9 = b, this.$7 = "", this.$1 = "", this.$6 = "", this.$5 = "", this.$3 = "", this.$4 = !1, this.$8 = {}, this.$2 = !1, o(this, a, !0, b)
                    }
                    q.prototype.setProtocol = function(a) {
                        "use strict";
                        i.isAllowed(a) || (g("uri").mustfix("You attempted to set the protocol of a URI to `%s`. That protocol does not pass the `URISchemes.isAllowed` test.", a), k(0, 587, a));
                        this.$7 = a;
                        return this
                    };
                    ...
                    q.prototype.setDomain = function(a) {
                        "use strict";
                        if (m.test(a)) throw new Error(j("URI.setDomain: unsafe domain specified: %s for url %s", a, this.toString()));
                        this.$1 = a;
                        return this
                    };
                ...
                __d("Queue", [], (function(a, b, c, d, e, f) {
                    ...
                    h.prototype._dispatch = function(a) {
                        ...
                        if (this._opts.interval) this._opts.processor.call(this, this._queue.shift()), this._timeout = setTimeout(ES(this._dispatch, "bind", !0, this), this._opts.interval);
                        else
                ...
                __d("Flash", ["DOMWrapper", "QueryString", "UserAgent_DEPRECATED", "guid", "htmlSpecialChars", "sdk.DOMEventListener"], (function(a, b, c, d, e, f, g, h, i, j, k, l) {
                    __p && __p();
                    var m = {},
                    ...
                    function s(a) {
                        n || (i.ie() >= 9 && l.add(window, "unload", q), n = !0), m[a] = a
                    }
                    var t = {
                        embed: function(a, b, c, d) {
                            ...
                            typeof c.flashvars === "object" && (c.flashvars = h.encode(c.flashvars));
                            d = [];
                            for (var f in c) Object.prototype.hasOwnProperty.call(c, f) && c[f] && d.push('<param name="' + k(f) + '" value="' + k(c[f]) + '">');
                            b = b.appendChild(o.createElement("span"));
                            a = "<object " + (i.ie() ? 'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" ' : 'type="application/x-shockwave-flash"') + 'data="' + a + '" ' + (c.height ? 'height="' + c.height + '" ' : "") + (c.width ? 'width="' + c.width + '" ' : "") + 'id="' + e + '">' + d.join("") + "</object>";
                            b.innerHTML = a;
                            c = b.firstChild;
                            s(e);
                            return c
                ...
                __d("XDM", ["DOMWrapper", "Flash", "GlobalCallback", "Log", "UserAgent_DEPRECATED", "emptyFunction", "guid", "sdk.DOMEventListener", "wrapFunction"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
                    __p && __p();
                    var p = {},
                        q = {
                            transports: []
                    ...
                    a = {
                        register: function(a, b) {
                            j.debug("Registering %s as XDM provider", a), q.transports.push(a), p[a] = b
                        },
                        create: function(a) {
                            __p && __p();
                            ...
                            a.channel || (j.warn("Missing channel name, selecting at random"), a.channel = m());
                            ...
                            init: function(f) {
                                ...
                                var g = {
                                    send: function(a, c, d, e) {
                                        j.debug("sending to: %s (%s)", c, e), b.postMessage(a, c, e)
                                    }
                                };
                                if (a) {
                                    f.whenReady(g);
                                ...
                                var k = f.root.appendChild(r.document.createElement("div")),
                                    l = i.create(function() {
                                        i.remove(l);
                                        clearTimeout(e);
                                        j.info("xdm.swf called the callback");
                                        var a = i.create(function(a, b) {
                                            a = decodeURIComponent(a), b = decodeURIComponent(b), j.debug("received message %s from %s", a, b), f.onMessage(a, b)
                                        }, "xdm.swf:onMessage");
                                        b.init(f.channel, a);
                                        f.whenReady(g)
                                    }, "xdm.swf:load");
                                ...
                                e = setTimeout(function() {
                                    j.warn("The Flash component did not load within %s ms - verify that the container is not set to hidden or invisible using CSS as this will cause some browsers to not load the components", d)
                                }, d);
                                a = !0
                            }
                        }
                    ...
                    a.register("postmessage", function() {
                        ...
                        return {
                            ...
                            init: function(b) {
                                ...
                                var c = "_FB_" + b.channel,
                                    d = {
                                        send: function(a, b, c, d) {
                                            ...
                                            k.ie() == 8 || k.ieCompatibilityMode() ? setTimeout(e, 0) : e()
                                        }
                                    };
                                if (a) {
                                    b.whenReady(d);
                                ...
                                n.add(r, "message", o(function(event) {
                                    __p && __p();
                                    var a = event.data,
                                        d = event.origin || "native";
                                    if (!/^(https?:\/\/|native$)/.test(d)) {
                                        j.debug("Received message from invalid origin type: %s", d);
                                        return
                                    }
                                    if (d !== "native" && !(t.test(location.hostname) || t.test(event.origin))) return;
                                    if (typeof a !== "string") {
                                        j.warn("Received message of type %s from %s, expected a string", typeof a, d);
                                        return
                                    }
                ...
                __d("sdk.createIframe", ["getBlankIframeSrc", "guid", "hasNamePropertyBug", "isNumberLike", "sdk.DOMEventListener"], (function(a, b, c, d, e, f, g, h, i, j, k) {
                    __p && __p();
                    function a(a) {
                        __p && __p();
                        ...
                        var b, c = a.name || h(),
                            ...
                            l = a.onload,
                            m = a.onerror;
                        i() ? b = document.createElement('<iframe name="' + c + '"/>') : (b = document.createElement("iframe"), b.name = c);
                        delete a.style;
                        delete a.name;
                        delete a.url;
                        delete a.root;
                        ...
                        b.src = g();
                        d.appendChild(b);
                        if (l) var o = k.add(b, "load", function() {
                            o.remove(), l()
                        });
                        if (m) var p = k.add(b, "error", function() {
                            p.remove(), m()
                        });
                        b.src = f;
                        return b
                ...
                __d("sdk.XD", ["JSSDKXDConfig", "Log", "QueryString", "Queue", "UrlMap", "XDM", "guid", "isFacebookURI", "sdk.Content", "sdk.createIframe", "sdk.Event", "sdk.feature", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.URI"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
                    ...
                    function K(a, b) {
                        ...
                        switch (a.xd_action) {
                            case "proxy_ready":
                                ...
                                h.info("Proxy ready, starting queue containing %s messages", c.getLength());
                                c.start(function(a) {
                                    D.send(typeof a === "string" ? a : i.encode(a), b, d.contentWindow, B + "_" + z)
                                });
                                break;
                            case "plugin_ready":
                                ...
                                if (j.exists(a.name)) {
                                    c = j.get(a.name);
                                    h.debug("Enqueuing %s messages for %s in %s", c.getLength(), a.name, z + "ProxyQueue");
                                    x.merge(c)
                                }
                                break
                        }
                    ...
                    function M(a, b) {
                        if (a == "facebook") b.relation = "parent.parent", w.enqueue(b);
                        else {
                            b.relation = 'parent.frames["' + a + '"]';
                            var c = H[a];
                            c ? (h.debug("Enqueuing message for plugin %s in %s", a, c.protocol + "ProxyQueue"), x.enqueue(b)) : (h.debug("Buffering message for plugin %s", a), j.get(a).enqueue(b))
                        }
                    }
                ...
                __d("sdk.Auth", ["DOMWrapper", "Log", "OAuthControllerParameterName", "ObservableMixin", "UrlMap", "WebStorage", "guid", "sdk.Cookie", "sdk.createIframe", "sdk.feature", "sdk.getContextType", "sdk.Impressions", "sdk.Runtime", "sdk.Scribe", "sdk.SignedRequest", "sdk.URI", "sdk.XD"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w) {
                    __p && __p();
                    var x = "fblst_",
                        y = "fblo_",
                        z = 365 * 24 * 60 * 60 * 1e3,
                    ...
                    function D(a, b) {
                        ...
                        e = s.getLoginStatus();
                        var f = e === "unknown" && a || s.getUseCookie() && s.getCookieUserID() !== d,
                            g = c && !a;
                        c = a && c && c != d;
                        var h = a != A;
                        e = b != (e || "unknown");
                    ...
                    function F(a, b, c) {
                        ...
                        return function(d) {
                            ...
                            if (d && d.access_token) {
                                ...
                                d.granted_scopes && (b = babelHelpers["extends"]({}, b, {
                                    grantedScopes: d.granted_scopes
                                }));
                                d.reauthorize_required_in && (b = babelHelpers["extends"]({}, b, {
                                    reauthorize_required_in: parseInt(d.reauthorize_required_in, 10)
                                }));
                                d.data_access_expiration_time && (b = babelHelpers["extends"]({}, b, {
                                    data_access_expiration_time: Number(d.data_access_expiration_time)
                                }));
                                d.enforce_https && (e = !0);
                                if (s.getUseLocalStorage() && location.protocol === "https:" && d.long_lived_token) {
                                    f = l.getLocalStorage();
                                    f && f.setItem(x + s.getClientID(), d.long_lived_token)
                                }
                                if (s.getUseCookie()) {
                                    f = b.expiresIn === 0 ? 0 : ES("Date", "now", !1) + b.expiresIn * 1e3;
                                    var g = n.getDomain();
                                ...
                                g = "connected";
                                D(b, g)
                            } else(c === "logout" || c === "login_status") && (d && d.error && d.error === "not_authorized" ? (g = "not_authorized", D(null, g)) : d && d.error && d.error === "authorization_expired" ? (g = "authorization_expired", D(null, g)) : (g = "unknown", D(null, g)), s.getUseCookie() && n.clearSignedRequestCookie(), c === "logout" && (H(), t.log("jssdk_error", {
                                appId: s.getClientID(),
                    ...
                    function I(a) {
                        ...
                        d = new v(k.resolve("www") + "/connect/ping").addQueryData(i.CLIENT_ID, s.getClientID()).addQueryData(i.RESPONSE_TYPE, "token,signed_request").addQueryData(i.DOMAIN, location.hostname).addQueryData(i.ORIGIN, q()).addQueryData(i.REDIRECT_URI, w.handler(function(a) {
                            ...
                            e(a) && (B = setTimeout(function() {
                                I(function() {})
                            }, 12e5))
                        }, "parent")).addQueryData(i.SDK, "joey").addQueryData(i.VERSION, s.getIsVersioned() ? s.getVersion() : null);
                    ...
                    function a(a, b) {
                        ...
                        J = "loading";
                        c = function(a) {
                            J = "loaded", C.inform("FB.loginStatus", a), C.clearSubscribers("FB.loginStatus")
                        };
                        I(c)
                    }
                ...
                __d("FB", ["DOMWrapper", "GlobalCallback", "JSSDKCssConfig", "Log", "dotAccess", "sdk.Auth", "sdk.Content", "sdk.DOM", "sdk.domReady", "sdk.ErrorHandling", "sdk.Runtime"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
                    __p && __p();
                    var r = window.FB = {};
                    b = {};
                    j.level = 0;
                    ...
                    g.setRoot(s);
                    o(function() {
                        j.info("domReady"), m.appendHidden(s), i.rules && n.addCssRules(i.rules, i.components)
                    });
                    q.subscribe("AccessToken.change", function(a) {
                        !a && q.getLoginStatus() === "connected" && l.getLoginStatus(null, !0)
                    });
                    function t(a, b, c, d) {
                        __p && __p();
                        return p.guard(function() {
                            ...
                            function e(a) {
                                ...
                                return a && typeof a === "object" && a.__wrapped ? a.__wrapped : typeof a === "function" && /^function/.test(a.toString()) ? p.unguard(a) : a
                            }
                            ...
                            if (g && typeof g === "object") {
                                ...
                                for (var c in g) {
                                    var j = g[c];
                                    if (typeof j !== "function" || c === "constructor") continue;
                                    i = !1;
                                    h[c] = t(j, b + ":" + c, c, g)
                                }
                            }
                ...
                __d("CORSRequest", ["QueryString", "RequestConstants", "sdk.safelyParseResponse", "wrapFunction"], (function(a, b, c, d, e, f, g, h, i, j) {
                    ...
                    function k(a, b) {
                        ...
                        var c = new XMLHttpRequest(),
                            d = function() {};
                        if ("withCredentials" in c) c.open(a, b, !0), c.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                    ...
                    function a(a, b, c, d) {
                        ...
                        b.onerror = function(b) {
                            b.responseText ? d(i(b.responseText, a)) : d({
                                error: babelHelpers["extends"]({}, h.PARSE_ERROR_TEMPLATE, {
                                    status: b.status
                                })
                            })
                        };
                ...
                __d("ChunkedRequest", ["GraphBatchConstants", "QueryString", "RequestConstants", "sdk.safelyParseResponse", "wrapFunction"], (function(a, b, c, d, e, f, g, h, i, j, k) {
                    ...
                    function a(a, b, c, d) {
                        ...
                        b.onerror = function(a) {
                            a.responseText ? d(j(a.responseText)) : d({
                                error: babelHelpers["extends"]({}, i.PARSE_ERROR_TEMPLATE, {
                                    status: a.status
                                })
                            })
                        };
                ...
                __d("JSONPRequest", ["DOMWrapper", "GlobalCallback", "QueryString"], (function(a, b, c, d, e, f, g, h, i) {
                    ...
                    function a(a, b, c, d) {
                        ...
                        var e = document.createElement("script"),
                            f = function(a) {
                                f = function() {}, h.remove(c.callback), d(a), e.parentNode.removeChild(e)
                            };
                ...
                __d("ApiClient", ["ApiBatcher", "ApiClientUtils", "Assert", "ChunkedRequest", "CORSRequest", "JSONPRequest", "Log", "ObservableMixin", "QueryString", "UrlMap", "flattenObject"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
                    __p && __p();
                    var r, s, t, u = l.MAX_QUERYSTRING_LENGTH,
                        v = {
                            fql_query: !0,
                            fql_multiquery: !0,
                            friends_get: !0,
                    ...
                    function C(a, b, c, d) {
                        ...
                        g.length > 0 && (a = o.appendToUrl(a, f), ES(g, "forEach", !0, function(a) {
                            return delete c[a]
                        }));
                        c.transport ? (f = [c.transport], delete c.transport) : f = w;
                    ...
                    function D(a, b, c, d, e, f, g, h) {
                        ...
                        g && g.error && F.inform("request.error", b, c, d, g, ES("Date", "now", !1) - e, f);
                        F.inform("request.complete", b, c, d, g, ES("Date", "now", !1) - e, f);
                        x--;
                        a && a(g);
                        h = y.length > 0 && x < z;
                        if (h) {
                    ...
                    function E() {
                        ...
                        var d = h.parseCallDataFromArgs(b),
                            ...
                            i = g.method;
                        G(e, i) && (i = "post");
                        var j = e.getProtocol() && e.getDomain() ? e.setQueryData({}).toString() : p.resolve("graph") + e.getPath(),
                            k = A++;
                        F.inform("request.prepare", j, g, k);
                        C(j, i == "get" ? "get" : "post", g, ES(D, "bind", !0, null, f, e.getPath(), i, g, ES("Date", "now", !1), k))
                    }
                    function a() {
                        var a;
                        B || (B = new g(E, s));
                    ...
                    function b(a, b) {
                        ...
                        var d = A++;
                        b = ES(D, "bind", !0, null, b, "/restserver.php", "get", a, ES("Date", "now", !1), d);
                        C(c, "get", a, b)
                    }
                ...
                __d("sdk.unsecureDisallowed", ["Log", "sdk.feature", "sdk.Runtime", "sdk.Scribe"], (function(a, b, c, d, e, f, g, h, i, j) {
                    "use strict";
                    __p && __p();
                    var k = h("https_only_enforce_starting", !1),
                        ...
                        m = {};
                    function a(a) {
                        if (location.protocol !== "https:" && k && k - ES("Date", "now", !1) <= 0) {
                            g.log("error", -1, "The method FB.%s can no longer be called from http pages. %s", a, l);
                            return !0
                        }
                        location.protocol !== "https:" && k && (g.log("error", -1, "The method FB.%s will soon stop working when called from http pages. Please update your site to use https for Facebook Login. %s", a, l), h("https_only_scribe_logging", !0) && !Object.prototype.hasOwnProperty.call(m, a) && (j.log("jssdk_error", {
                            appId: i.getClientID(),
                            error: "HttpsOnly",
                            extra: {
                                message: a
                ...
                __d("sdk.api", ["ApiClient", "sdk.feature", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.Scribe", "sdk.URI", "sdk.unsecureDisallowed"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m) {
                    __p && __p();
                    ...
                    g.subscribe("request.error", function(a, b, c, d) {
                        n && d.error.type === "http" && k.log("jssdk_error", {
                            appId: j.getClientID(),
                            error: "transport",
                            extra: {
                                name: "transport",
                    ...
                    var w = h.extend({
                        ...
                        x = {
                            ...
                            _createMobileLoader: function() {
                                ...
                                return x.create({
                                    classes: "loading" + (x.isTabletStyle() ? " centered" : ""),
                                    content: a
                                })
                            },
                            ...
                            _handleOrientationChange: function() {
                                ...
                                if (x.isTabletStyle()) x._setDialogSizes(!0), x._centerActive(), x._setDialogOverlayStyle();
                                else {
                ...
                __d("sdk.NativeExtensions", ["Log", "sdk.DOMEventListener", "sdk.UA"], (function(a, b, c, d, e, f, g, h, i) {
                    __p && __p();
                ...
                __d("sdk.Extensions", ["JSONRPC", "Queue", "sdk.NativeExtensions", "sdk.UA"], (function(a, b, c, d, e, f, g, h, i, j) {
                    ...
                    j.facebookInAppBrowser() && i.onReady(function(a) {
                        n = a, window._FBBrowserCallbackHandler = function(a) {
                ...
                __d("sdk.UIServer", ["JSSDKConfig", "Log", "QueryString", "UrlMap", "createObjectFrom", "flattenObject", "guid", "insertIframe", "resolveURI", "sdk.Auth", "sdk.Content", "sdk.Dialog", "sdk.DOM", "sdk.Event", "sdk.Extensions", "sdk.fbt", "sdk.feature", "sdk.Frictionless", "sdk.getContextType", "sdk.Native", "sdk.openMessenger", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.UA", "sdk.XD"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F) {
                    ...
                    function J(a) {
                        return H(a) && (a.is_account_link === !0 || a.is_account_link === "true") && u.supportsDialog("accountLink")
                    }
                    a = {
                        "stream.share": {
                            size: {
                        ...
                        "permissions.oauth": {
                            url: "dialog/oauth",
                            size: {
                                width: E.mobile() ? null : 600,
                                height: E.mobile() ? null : 679
                            },
                            transform: function(a) {
                                __p && __p();
                                if (!C.getClientID()) {
                                ...
                                a.params.display === "async" ? (ES("Object", "assign", !1, a.params, {
                                    ...
                                    response_type: e,
                                    domain: location.hostname
                                }), a.cb = p.xdResponseWrapper(b, p.getAuthResponse(), "permissions.oauth")) : (d && N._xdNextHandler(function(a) {
                                    b({
                                        authResponse: null,
                                    ...
                                    client_id: C.getClientID(),
                                    redirect_uri: o(N.xdHandler(b, c, "opener", p.getAuthResponse(), "permissions.oauth", !d)),
                                    origin: y(),
                                    response_type: e,
                                    domain: location.hostname
                                }));
                        ...
                        "auth.logout": {
                            url: "logout.php",
                            transform: function(a) {
                                if (!C.getClientID()) h.error("FB.logout() called before calling FB.init().");
                                else if (!p.getAuthResponse()) h.error("FB.logout() called without an access token.");
                                else {
                                    a.params.next = N.xdHandler(a.cb, a.id, "parent", p.getAuthResponse(), "logout", !0);
                                    return a
                                }
                            }
                        },
                        "login.status": {
                            ...
                            transform: function(a) {
                                ...
                                ES("Object", "assign", !1, a.params, {
                                    client_id: C.getClientID(),
                                    redirect_uri: N.xdHandler(b, c, "parent", p.getAuthResponse(), "login_status", !0),
                                    origin: y(),
                    ...
                    var N = {
                        ...
                        prepareCall: function(a, b) {
                            ...
                            var c = a.method.toLowerCase(),
                                d = Object.prototype.hasOwnProperty.call(N.Methods, c) ? ES("Object", "assign", !1, {}, N.Methods[c]) : {},
                                e = m(),
                                f = !0;
                            ...
                            (d.url == "dialog/oauth" || d.url == "dialog/permissions.request") && (a.display == "iframe" || a.display == "touch" && a.in_iframe) && (a.display = N.checkOauthDisplay(a));
                            ...
                            f = {
                                ...
                                url: j.resolve(a.display == "touch" ? "m" : "www") + "/" + d.url,
                                params: a,
                                name: c,
                            ...
                            a.display === "touch" && a.in_iframe && (f.params.parent_height = window.innerHeight);
                            c = d.getXdRelation || N.getXdRelation;
                            b = c(f.params);
                            !(f.id in N._defaultCb) && !("next" in f.params) && !("redirect_uri" in f.params) && (f.params.next = N._xdResult(f.cb, f.id, b, !0));
                            (b === "parent" || b === "opener") && ES("Object", "assign", !1, f.params, {
                                channel_url: N._xdChannelHandler(e, b === "parent" ? "parent.parent" : "opener")
                            }, !0);
                            f = N.prepareParams(f);
                            return f
                        },
                        prepareParams: function(a) {
                            ...
                            !E.nativeApp() && N.urlTooLongForIE(a.url + "?" + b) ? a.post = !0 : b && (a.url += "?" + b);
                            return a
                        },
                        ...
                        getDisplayMode: function(a, b) {
                            ...
                            if ((b.display == "iframe" || b.display == "dialog") && !N.canIframe(b)) {
                                h.error('"dialog" mode can only be used when the user is connected.');
                                return "popup"
                            }
                            return a.connectDisplay && !c ? a.connectDisplay : b.display || (N.canIframe(b) ? "dialog" : "popup")
                        },
                        ...
                        popup: function(a) {
                            ...
                            c = c.join(",");
                            a.post ? (e = window.open("about:blank", a.id, c), e && (N.setLoadedNode(a, e, "popup"), q.submitToTarget({
                                url: a.url,
                                target: a.id,
                                params: a.params
                            }))) : (e = window.open(a.url, a.id, c), e && N.setLoadedNode(a, e, "popup"));
                            if (!e) {
                        ...
                        hidden: function(a) {
                            a.className = "FB_UI_Hidden", a.root = q.appendHidden(""), N._insertIframe(a)
                        },
                        iframe: function(a) {
                            __p && __p();
                            ...
                            a.params.mobile_iframe && (c.styles = {
                                "border-radius": "8px"
                            });
                            a.root = r.create(c);
                        ...
                        touch: function(a) {
                            ...
                            }, 0) : N.iframe(a) : E.nativeApp() && !a.ui_created ? (a.frame = a.id, z.onready(function() {
                                N.setLoadedNode(a, z.open(a.url + "#cb=" + a.frameName), "native")
                        ...
                        async: function(a) {
                            ...
                            I(a.params) || J(a.params) ? (a.params.method = "oauth", a.params.redirect_uri = a.params.next, u.remote.showDialog(a.params, b)) : B.remote.showDialog(a.params, b)
                        },
                        "native": function(a) {
                            A(a.params)
                        },
                        ...
                        _popupMonitor: function() {
                            ...
                            for (var b in N._loadedNodes)
                                if (Object.prototype.hasOwnProperty.call(N._loadedNodes, b) && b in N._defaultCb) {
                            ...
                            a && !N._popupInterval ? N._popupInterval = setInterval(N._popupMonitor, 100) : !a && N._popupInterval && (clearInterval(N._popupInterval), N._popupInterval = null)
                        },
                        ...
                        _xdRecv: function(a, b) {
                            ...
                            if (c)
                                if (c.close) try {
                                    c.close(), /iPhone.*Version\/(5|6)/.test(navigator.userAgent) && RegExp.$1 !== "5" && window.focus(), N._popupCount--
                                } catch (a) {} else s.containsCss(c, "FB_UI_Hidden") ? setTimeout(function() {
                        ...
                        xdHandler: function(a, b, c, d, e, f) {
                            return N._xdNextHandler(p.xdResponseWrapper(a, d, e), b, c, f)
                        }
                    };
                    u.stub("showDialog");
                    B.stub("showDialog");
                ...
                __d("sdk.ui", ["Assert", "Log", "sdk.feature", "sdk.Impressions", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.UIServer", "sdk.URI"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    __p && __p();
                    function a(a, b) {
                        __p && __p();
                        g.isObject(a);
                        ...
                        d && a.dialog.subscribe("e2e:end", function(a) {
                            a.method = c, a.display = e, h.debug("e2e: %s", ES("JSON", "stringify", !1, a)), j.log(114, {
                                payload: a
                            })
                        });
                        b(a);
                ...
                __d("legacy:fb.auth", ["FB", "Log", "sdk.Auth", "sdk.Cookie", "sdk.Event", "sdk.Runtime", "sdk.SignedRequest", "sdk.ui", "sdk.unsecureDisallowed"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
                    __p && __p();
                    g.provide("", {
                        getLoginStatus: function() {
                            return o("getLoginStatus") ? null : i.getLoginStatus.apply(i, arguments)
                        },
                        getAuthResponse: function() {
                            return o("getAuthResponse") ? null : i.getAuthResponse()
                        },
                        getAccessToken: function() {
                            return o("getAccessToken") ? null : l.getAccessToken() || null
                        },
                        getUserID: function() {
                            return o("getUserID") ? null : l.getUserID() || l.getCookieUserID()
                        },
                        login: function(a, b) {
                            if (o("login")) return;
                            b && b.perms && !b.scope && (b.scope = b.perms, delete b.perms, h.warn("OAuth2 specification states that 'perms' should now be called 'scope'.  Please update."));
                    ...
                    }), i.subscribe("logout", ES(k.fire, "bind", !0, k, "auth.logout")), i.subscribe("login", ES(k.fire, "bind", !0, k, "auth.login")), i.subscribe("authresponse.change", ES(k.fire, "bind", !0, k, "auth.authResponseChange")), i.subscribe("status.change", ES(k.fire, "bind", !0, k, "auth.statusChange")), k.subscribe("init:post", function(a) {
                        __p && __p();
                        a.status && i.getLoginStatus();
                        if (l.getClientID())
                            if (a.authResponse) i.setAuthResponse(a.authResponse, "connected");
                ...
                __d("sdk.Canvas.Plugin", ["Log", "sdk.api", "sdk.RPC", "sdk.Runtime", "sdk.UA"], (function(a, b, c, d, e, f, g, h, i, j, k) {
                    ...
                    i.local.hidePluginObjects = function() {
                        g.info("hidePluginObjects called"), v({
                            state: "opened"
                        })
                    };
                    i.local.showPluginObjects = function() {
                        g.info("showPluginObjects called"), v({
                            state: "closed"
                        })
                    };
                ...
                __d("sdk.init", ["Log", "ManagedError", "QueryString", "sdk.Cookie", "sdk.ErrorHandling", "sdk.Event", "sdk.MBasicInitializer", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.UA", "sdk.URI"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
                    ...
                    function s(a) {
                        ...
                        } else /number|string/.test(typeof a) && (g.warn("FB.init called with invalid parameters"), a = {
                            apiKey: a
                        ...
                        (a.localStorage === !1 || a.localStorage === "false") && o.setUseLocalStorage(!1);
                ...
                __d("sdk.Time", ["Log", "sdk.feature", "sdk.Impressions", "sdk.Runtime"], (function(a, b, c, d, e, f, g, h, i, j) {
                    ...
                    if (l) {
                        var o = j.getSDKUrl();
                        a = null;
                        b = ES(k.getEntriesByType("resource"), "filter", !0, function(a) {
                        ...
                        if (b.length > 1)
                            ...
                            d && d instanceof HTMLIFrameElement && (a = d.contentWindow.performance.getEntriesByType("resource").find(function(a) {
                                return ES(a.name, "startsWith", !0, o)
                            }));
                            b = b[0]
                        } else b = null;
                        b && (n.fetchTime = Math.round(b.duration), a && (n.fetchTime += Math.round(a.duration)), "transferSize" in b && (n.transferSize = b.transferSize, a && (n.transferSize += a.transferSize)), g.debug("sdkperf: it took %s ms and %s bytes to load %s", n.fetchTime, n.transferSize, o), m = b.startTime, n.ns = j.getSDKNS(), m && setTimeout(function() {
                            var a = h("log_perf", !1),
                                b = j.getSDKAB();
                            b && (n.ab = b, a = !0);
                            a && i.log(116, n)
                ...
                __d("sdk.XFBML.Comments", ["QueryString", "UrlMap", "sdk.Event", "sdk.Runtime", "sdk.UA", "sdk.XFBML.IframeWidget"], (function(a, b, c, d, e, f, g, h, i, j, k, l) {
                    __p && __p();
                    var m = 320;
                    a = l.extend({
                        ...
                        setupAndValidate: function() {
                            ...
                            if (!a.href) {
                                ...
                                a.migrated && (a.href = h.resolve("www") + "/plugins/comments_v1.php?app_id=" + j.getClientID() + "&xid=" + encodeURIComponent(a.xid) + "&url=" + encodeURIComponent(a.url))
                            } else {
                                b = this.getAttribute("fb_comment_id");
                                b || (b = g.decode(document.URL.substring(ES(document.URL, "indexOf", !0, "?") + 1)).fb_comment_id, b && ES(b, "indexOf", !0, "#") > 0 && (b = b.substring(0, ES(b, "indexOf", !0, "#"))));
                        ...
                        getSize: function() {
                            if (!this._attr.permalink) return {
                                width: this._attr.mobile || this._attr.width === "auto" || this._attr.width === "100%" ? "100%" : Math.max(this._attr.width, m),
                                height: 100
                            }
                        },
                        getUrlBits: function() {
                ...
                __d("sdk.XFBML.CommentsCount", ["ApiClient", "Log", "sdk.DOM", "sdk.XFBML.Element", "sprintf"], (function(a, b, c, d, e, f, g, h, i, j, k) {
                    __p && __p();
                    a = j.extend({
                        process: function() {
                            ...
                            g.scheduleBatchCall("/v2.1/" + encodeURIComponent(a), {
                                fields: "share"
                            }, ES(function(a) {
                                a = a.share && a.share.comment_count || 0;
                                i.html(this.dom, k('<span class="fb_comments_count">%s</span>', a));
                                a > 0 && i.removeCss(this.dom, "fb_comments_count_zero");
                                this.fire("render")
                            }, "bind", !0, this))
                        }
                    });
                ...
                __d("sdk.XFBML.CustomerChat", ["IframePlugin", "QueryString", "getDocumentScrollElement", "sdk.Content", "sdk.createIframe", "sdk.DialogUtils", "sdk.DocumentTitle", "sdk.DOM", "sdk.DOMEventListener", "sdk.Event", "sdk.UA", "sdk.XD"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
                    "use strict";
                    __p && __p();
                    ...
                    a = g.extend({
                        constructor: function(a, b, c, d) {
                            n.addCss(a, "fb_invisible_flow"), n.remove(a), j.append(a), this.parent(a, b, c, d), this._iframeOptions.title = "", p.fire("customerchat.load"), this._setUpSubscriptions()
                        },
                        _setUpSubscriptions: function() {
                            ...
                            this.subscribe("xd.liveChatPluginGetBubbleIframe", ES(function(a) {
                                ...
                                z = ES("JSON", "parse", !1, a.passesMobileRedesignGK), ES("JSON", "parse", !1, a.isMobile) ? this._handlePrepareMobileAnchorIframe(a) : this._handlePrepareDesktopAnchorIframe(a)
                            ...
                            }, "bind", !0, this)), this.subscribe("xd.liveChatPluginShowInterstitialOnPage", ES(function(a) {
                            ...
                            }, "bind", !0, this)), this.subscribe("xd.liveChatPluginExpandMobilePrompt", ES(function(a) {
                                this._handleExpandMobilePrompt()
                            }, "bind", !0, this)), q.iphone() && (this.subscribe("xd.liveChatPluginFocusComposer", ES(function(a) {
                        ...
                        _handleGetBubbleIframe: function(a) {
                            this._bubbleDialog = this._setupNewIframeDialog(a.fromIframe), v = this._bubbleDialog, j.append(this._bubbleDialog), this.subscribe("xd.liveChatPluginShowBubbleIframe", ES(function(a) {
                                n.setStyle(this._bubbleDialog, "display", "inline"), u && (n.addCss(this._bubbleDialog, "fb_customer_chat_bubble_pop_in"), ES("JSON", "parse", !1, a.dialogHidden) || setTimeout(ES(function() {
                        ...
                        _handlePrepareDesktopAnchorIframe: function(a) {
                            this._iframe && (this._iframe.setAttribute("data-testid", "dialog_iframe"), ES("Object", "assign", !1, this._iframe.style, {
                                ...
                                width: "288pt",
                                zIndex: "2147483647"
                            }), n.setStyle(this._iframe, "maxHeight", ES("JSON", "parse", !1, a.dialogHidden) || u ? "0" : "100%"), ES("JSON", "parse", !1, a.chatStarted) && (w = !0, ES("Object", "assign", !1, this._iframe.style, {
                                height: "378pt"
                            })), x = this._iframe)
                        },
                        _handlePrepareMobileAnchorIframe: function(a) {
                            ...
                            if (this._iframe) {
                                ...
                                n.setStyle(this._iframe, "maxHeight", ES("JSON", "parse", !1, a.dialogHidden) || u ? "0" : "100%");
                                var b = ES("JSON", "parse", !1, a.chatStarted);
                                if (b) w = !0, ES("Object", "assign", !1, this._iframe.style, {
                                    boxShadow: "none",
                                    height: "100%",
                                    right: "0",
                                    top: "0",
                                ...
                                else ES("Object", "assign", !1, this._iframe.style, {
                                    borderRadius: "9pt",
                                    bottom: "63pt",
                                    right: "3pt",
                                    top: "auto",
                        ...
                        _handleResizeAnchorIframe: function(a) {
                            this._iframe && n.setStyle(this._iframe, "height", ES("JSON", "parse", !1, a.height) + "px")
                        },
                        _handleExpandDesktopDialogIframe: function() {
                            w = !0, this._iframe && n.setStyle(this._iframe, "height", "378pt")
                        },
                        ...
                        _handleHideDialogIframe: function(a) {
                            H(this._iframe, ES("JSON", "parse", !1, a.chatStarted), ES("JSON", "parse", !1, a.isMobile))
                        },
                        _handleShowInterstitialOnPage: function(a) {
                            !ES("JSON", "parse", !1, a.dialogHidden) ? (H(this._iframe, !1, !0, !1), setTimeout(ES(function() {
                                this._makeDialogIframeFullScreen(), C = !0, G(this._iframe, !1, !0, !0), E()
                            }, "bind", !0, this), 500)) : (this._makeDialogIframeFullScreen(), C = !0, G(this._iframe, !1, !0, !0))
                        },
                        _handleShadowUpdate: function(a) {
                            ES("JSON", "parse", !1, a.resetShadow) && this._bubbleDialog ? (n.setStyle(this._bubbleDialog, "borderRadius", "50%"), u ? n.addCss(this._bubbleDialog, "fb_customer_chat_bubble_animated_no_badge") : n.setStyle(this._bubbleDialog, "boxShadow", "0px 3px 12px rgba(0, 0, 0, 0.15)")) : ES("JSON", "parse", !1, a.resetShadow) || this._setBubbleBadgeStyle()
                        },
                        _handleUpdatePageTitle: function(a) {
                            !t && a.titleText ? (t = m.blink(a.titleText), o.add(window, "focus", ES(function(a) {
                                this._stopBlinking()
                        ...
                        _handleFocusComposer: function() {
                            setTimeout(ES(function() {
                                var a = i();
                                a && (n.setStyle(this._iframe, "maxHeight", a.scrollHeight - a.scrollTop + "px"), a.scrollTo(0, 0))
                            }, "bind", !0, this), 700)
                        },
                        ...
                        _setupNewIframeDialog: function(a) {
                            ...
                            u ? (n.removeCss(b.dialogElement, "fb_customer_chat_bubble_animated_with_badge"), n.addCss(b.dialogElement, "fb_customer_chat_bubble_animated_no_badge")) : n.setStyle(b.dialogElement, "boxShadow", "0px 3px 12px rgba(0, 0, 0, 0.15)");
                            return b.dialogElement
                        },
                        _setBubbleBadgeStyle: function() {
                            this._bubbleDialog && (n.setStyle(this._bubbleDialog, "borderRadius", "50% 0% 50% 50%"), u ? (n.removeCss(this._bubbleDialog, "fb_customer_chat_bubble_animated_no_badge"), n.addCss(this._bubbleDialog, "fb_customer_chat_bubble_animated_with_badge")) : n.setStyle(this._bubbleDialog, "boxShadow", "-5px 4px 14px rgba(0, 0, 0, 0.15)"))
                        },
                        _stopBlinking: function() {
                            t && (t.stop(), t = null)
                        },
                        _makeDialogIframeFullScreen: function() {
                            this._iframe && (n.setStyle(this._iframe, "boxShadow", "none"), n.setStyle(this._iframe, "border-radius", "0"), n.setStyle(this._iframe, "height", "100%"), n.setStyle(this._iframe, "right", "0"), n.setStyle(this._iframe, "top", "0"), n.setStyle(this._iframe, "width", "100%"))
                        },
                        getParams: function() {
                            return {
                                attribution: "string",
                    ...
                    function E() {
                        A = window.pageXOffset !== undefined ? window.pageXOffset : document.documentElement && document.documentElement.scrollLeft, B = window.pageYOffset !== undefined ? window.pageYOffset : document.documentElement && document.documentElement.scrollTop, n.addCss(document.body, "fb_mobile_overlay_active")
                    }
                    function F() {
                        n.removeCss(document.body, "fb_mobile_overlay_active"), window.scrollTo(A, B)
                    }
                    function G(a, b, c, d) {
                        __p && __p();
                        d === void 0 && (d = !0);
                        ...
                        if (D === null || D === !1) {
                            c && (b || z && C) && E();
                            if (u) {
                                c && (b || z && C) ? (c = "fb_customer_chat_bounce_in_v2_mobile_chat_started", b = "fb_customer_chat_bounce_out_v2_mobile_chat_started") : (c = "fb_customer_chat_bounce_in_v2", b = "fb_customer_chat_bounce_out_v2");
                                n.removeCss(a, b);
                                n.addCss(a, c)
                            }
                    ...
                    function H(a, b, c, d) {
                        ...
                        if (D === null || D === !0) {
                            ...
                            if (!u) n.setStyle(e, "maxHeight", "0");
                                ...
                                var f = function a(d) {
                                        var f;
                                        c && (b || z && C) ? f = "fb_bounce_out_v2_mobile_chat_started" : f = "fb_bounce_out_v2";
                                        d.animationName === f && (n.setStyle(e, "maxHeight", "0"), ES(s, "forEach", !0, function(event) {
                                            o.remove(e, event, a)
                                        }))
                                    },
                                    g;
                                c && (b || z && C) ? (a = "fb_customer_chat_bounce_in_v2_mobile_chat_started", g = "fb_customer_chat_bounce_out_v2_mobile_chat_started") : (a = "fb_customer_chat_bounce_in_v2", g = "fb_customer_chat_bounce_out_v2");
                                n.removeCss(e, a);
                                n.addCss(e, g);
                    ...
                    a.show = function(a) {
                        a === void 0 && (a = !0), n.setStyle(v, "display", "inline"), a && G(x, w, q.mobile(), !1), p.fire("customerchat.show")
                    };
                    a.hide = function() {
                        n.setStyle(v, "display", "none"), H(x, w, q.mobile(), !1), p.fire("customerchat.hide")
                    };
                ...
                __d("sdk.Helper", ["UrlMap", "safeEval", "sdk.ErrorHandling", "sdk.Event", "sprintf"], (function(a, b, c, d, e, f, g, h, i, j, k) {
                    ...
                    a = {
                        ...
                        upperCaseFirstChar: function(a) {
                            if (a.length > 0) return a.substr(0, 1).toUpperCase() + a.substr(1);
                            else return a
                        },
                ...
                __d("sdk.XFBML.LoginButton", ["IframePlugin", "Log", "sdk.feature", "sdk.Helper", "sdk.Runtime", "sdk.Scribe", "sdk.ui", "sdk.XD"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    __p && __p();
                        ...
                        constructor: function(a, b, c, d) {
                            ...
                            if (location.protocol !== "https:" && o) {
                                var e = Math.floor((o - ES("Date", "now", !1)) / 864e5) + 1,
                                    f = "The Login Button plugin will stop working on http pages in %s days. Please update your site to use https for Facebook Login. %s";
                                e > 30 ? h.log("warn", -1, f, e - 1, p) : o - ES("Date", "now", !1) > 0 ? h.log("error", -1, f, e - 1, p) : h.log("error", -1, "The Login Button plugin can no longer be used on http pages. %s", p);
                                i("https_only_scribe_logging", !0) && l.log("jssdk_error", {
                                    appId: k.getClientID(),
                                    error: "HttpsOnly",
                                    extra: {
                                        message: "LoginButton"
                            ...
                            this.subscribe("xd.login_button_dialog_open", function(a) {
                                m(ES("JSON", "parse", !1, a.params), function(a) {
                                    j.invokeHandler(r, null, [a]), n.sendToFacebook(s, {
                                        method: "loginReload",
                                        params: ES("JSON", "stringify", !1, a)
                                    })
                                })
                ...
                __d("sdk.XFBML.Name", ["ApiClient", "Log", "escapeHTML", "sdk.Event", "sdk.Helper", "sdk.Runtime", "sdk.Scribe", "sdk.XFBML.Element"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    ...
                    a = n.extend({
                        ...
                        _renderPronoun: function(a) {
                            ...
                            if (this._uid == l.getUserID() && this._getBoolAttribute("use-you", !0)) this._possessive ? this._reflexive ? b = "your own" : b = "your" : this._reflexive ? b = "yourself" : b = "you";
                            else switch (a.gender) {
                                case "male":
                    ...
                    a = g.extend({
                        constructor: function(a, b, c, d) {
                            ...
                            this.subscribe("xd.savePluginGetBlankIframe", ES(function(a) {
                                ...
                                c = this.setupNewIframeDialog(ES("JSON", "parse", !1, a.data), a.fromIframe);
                                g(c);
                                i.append(c);
                                d = [c, b];
                                var h = function() {
                        ...
                        setupNewIframeDialog: function(a, b) {
                            ...
                            ES("Object", "assign", !1, c.dialogElement.style, a.style || {});
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"4385443","namespace":"FB","message":"' + e.message + '"}}');
} 
